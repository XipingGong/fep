...
if [ $1 == 'genstr' ]; then
   ...
   # vac
   $gmx pdb2gmx -f $pdbid.box.pdb -o $pdbid.vac.gro -p $pdbid.vac.top -ff charmm36mw-feb2021-addsidechain -water none
   $gmx editconf -f $pdbid.vac.gro -o $pdbid.vac.pdb
   # solv
   $gmx pdb2gmx -f $pdbid.box.pdb -o $pdbid.box.gro -p $pdbid.solv.top -ff charmm36mw-feb2021-addsidechain -water tip3p
