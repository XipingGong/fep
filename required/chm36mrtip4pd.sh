...
if [ $1 == 'genstr' ]; then
   ...
   # vac
   $gmx pdb2gmx -f $pdbid.box.pdb -o $pdbid.vac.gro -p $pdbid.vac.top -ff c36mrtip4pd-addsidechain -water none
   ...
   $gmx solvate -cp $pdbid.box.gro -cs c36mrtip4pd-addsidechain.ff/a99SBdisp_water.gro -o $pdbid.solv.gro -p $pdbid.solv.top
